...
'
' No effort is wasted to add in-line documantation.
' Since there's only seven lines of code, and only three lines that
' perform computation, I feel that any further documentation would be
' condesending and would detract from the natural clarity of Visual Basic.
'
